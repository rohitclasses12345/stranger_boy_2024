    ...
    try:
        ...
        for i in range(len(links)):
            ...
            try:  
                ...
                cc = f'**╭━━━━━━━━━━━━━╮
👨🏻‍💻 𝐕ɪᴅᴇᴏ 𝐈𝐃 ➤ 
╰━━━━━━━━━━━━━╯: {str(count).zfill(3)}.\n\n📄 Title ├──𝐓ɪᴛʟᴇ:➤: {name1} {res} ▌│█║▌║▌║ 𝗦𝗧𝗥𝗔𝗡𝗚𝗘𝗥 𝗕𝗢𝗬 𝗥𝗢𝗛𝗜𝗧 ║▌║▌║█│▌├── 𝗙𝗼𝗿𝗺𝗮𝘁 ➤.mkv\n\n<pre><code>🚶‍♂️🚶🧨🔖 Batch Name [🚀]𝐂ᴏᴜʀꜱᴇ:➤ : {b_name}</code></pre>\n\n📥 Extracted By : {CR} "https://t.me/Strangerboy27_bot_strangerboy"**'
                cc1 = f'**╭━━━━━━━━━━━━━╮
👨🏻‍💻 PDF 𝐈𝐃 ➤ 
╰━━━━━━━━━━━━━╯: {str(count).zfill(3)}.\n\n📄 Title ├──𝐓ɪᴛʟᴇ:➤: {name1} ▌│█║▌║▌║ 𝗦𝗧𝗥𝗔𝗡𝗚𝗘𝗥 𝗕𝗢𝗬 𝗥𝗢𝗛𝗜𝗧 ║▌║▌║█│▌├── 𝗙𝗼𝗿𝗺𝗮𝘁 ➤.pdf \n\n<pre><code>🚶‍♂️🚶🧨🔖 Batch Name [🚀]𝐂ᴏᴜʀꜱᴇ:➤ : {b_name}</code></pre>\n\n📥 Extracted By : {CR} "https://t.me/Strangerboy27_bot_strangerboy"**'
        ...
        # Check if the response status is OK
            ...
            # Remove the PDF file after sending
                ...
                await m.reply_text(
                    f"⌘ 𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝𝐢𝐧𝐠 ╭━━━━━━━━━━━━━╮
👨🏻‍💻 DOWNLOADING ME KUCH PROBLEM HAI
╰━━━━━━━━━━━━━╯😡🤬😈👿☠️ https://envs.sh/tmQ.jpg  💔𝐈𝐧𝐭𝐞𝐫𝐮𝐩𝐭𝐞𝐝\n\n⌘ 𝐍𝐚𝐦𝐞 » {name}\n⌘ 𝐋𝐢𝐧𝐤 » `{url}`"
                )
                continue
